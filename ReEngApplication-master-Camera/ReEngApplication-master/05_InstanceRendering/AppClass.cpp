...
void AppClass::InitVariables(void)
{
	...
	m_pMesh->AddVertexPosition(vector3(2.0f, 4.0f, 0.0f));
	...
	m_pMesh->AddVertexPosition(vector3(2.0f, -4.0f, 0.0f));
	m_pMesh->AddVertexPosition(vector3(6.0f, -4.0f, 0.0f));
	m_pMesh->AddVertexPosition(vector3(4.0f, 0.0f, 0.0f));
	...
	const float* m4MVP = glm::value_ptr(glm::translate(0.0f, 0.0f, 0.0f));
	memcpy(&m_fMatrixArray[0], m4MVP, 16 * sizeof(float));
	m4MVP = glm::value_ptr(glm::translate(-4.0f, -8.0f, 0.0f));
	memcpy(&m_fMatrixArray[16], m4MVP, 16 * sizeof(float));
	m4MVP = glm::value_ptr(glm::translate(4.0f, -8.0f, 0.0f));
	memcpy(&m_fMatrixArray[32], m4MVP, 16 * sizeof(float));
